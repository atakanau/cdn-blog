( function( $ ) {
	...
	$( window ).ready( menuDropdownToggle ).on("resize",function(){ debounce( menuDropdownToggle, 500 ) } );
	...
	$( window ).ready( function() {
		...
		$( '.dropdown-togglenbt' ).on("click", function( event ) {
...
( function( $ ) {
	...
	$( window ).ready( function() {
		...
		searchSubmit.on("mouseenter focusin", searchAddClass );
		searchSubmit.on("mouseleave focusout", searchRemoveClass );
